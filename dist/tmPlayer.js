var bundle = (function (exports) {
	...
	var parserM3u8Index = function parserM3u8Index(data) {
	  return data.match(LEVEL_PLAYLIST_REGEX_FAST);
	};
	...
	function (_Player) {
	  ...
	  function HlsPlayer(options) {
	    ...
	    _this.indexUrl = 'https://video-dev.github.io/streams/x36xhzz/x36xhzz.m3u8';
	  ...
	  _createClass(HlsPlayer, [{
	    key: "loadM3u8File",
	    value: function loadM3u8File() {
	      loader.get(this.indexUrl).then(function (res) {
	        var m3u8Index = res.data;
	        var m3u8List = parserM3u8Index(res.data);
	        debugger;
	      });
	    }
	  }], [{
	    ...
	    value: function isSupported() {
	      return MediaSource && typeof mediaSource.isTypeSupported === 'function' && mediaSource.isTypeSupported('video/mp4; codecs="avc1.42E01E,mp4a.40.2"');
	    }
	  }]);
